...
# ==========================================================
# 1. Setup APPS Directory & Scripts
# ==========================================================
echo ">> [1/5] Installing APPS (YouTube & Kodi)..." | tee -a "$LOG_FILE"
sudo mkdir -p /roms/apps/images

# โหลดไฟล์สคริปต์ YouTube และ kodi
...
# โหลดรูปภาพปกทั้งหมดทีละไฟล์ (ใช้ Array เพื่อความคลีนของโค้ด)
