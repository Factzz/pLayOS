...
# 1.1 อัปเดต GameStore (ใน zip มีโฟลเดอร์ gamestore แตกที่ /opt)
...
# 1.2 อัปเดต YTC (ใน zip มีโฟลเดอร์ ytc แตกที่ /roms/ports)
...
# 1.3 อัปเดต Apps (ใน zip มีโฟลเดอร์ apps แตกที่ /roms)
sudo rm -rf /roms/apps
